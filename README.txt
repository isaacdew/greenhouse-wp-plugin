=== Plugin Name ===
Contributors: brownbagmarketing, circlecube, isaacdew
...
= 2.7.3 =
* Updated Admin page to allow a selection for "Use Custom CSS". The Custom CSS text area is now hidden unless the checkbox is selected.
* Updated jobs sort to only occur when shortcodes are used.
* Updated Admin page to allow user to remove "excerpt" via checkbox when the "cycle" Type is selected for the job board.
