 ...
 (function( $ ) {
	...
	$( window ).load(function() {
		...
		$('#custom-css').on('change', function(){
			if($(this).is(':checked')){
				$('.custom-css-textarea').removeClass('hide');
				$('.custom-css-textarea').addClass('show');
			}else{
				$('.custom-css-textarea').addClass('hide');
				$('.custom-css-textarea').removeClass('show');
			}
		});
		...
		// show/hide hide job checkbox 
		if($('#chooseBoardType').val() == 'accordion') {
			
			$('.the_excerpt').addClass('hide');
		}
		
		$('#chooseBoardType').change(function() {
			if ($(this).val() == 'accordion') {
				$('.the_excerpt').addClass('hide');
			}
			else {
				$('.the_excerpt').removeClass('hide');
			}
		});
