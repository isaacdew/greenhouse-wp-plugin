...
function greenhouse_job_board_type_render(  ) { 
	...
	?>
	<select id="chooseBoardType" name='greenhouse_job_board_settings[greenhouse_job_board_type]' class='regular-text'>
	...
	<div class="helper">Select the type of job board you would like to display on your site by default.</div><br>
	<div class="the_excerpt">
		<label>Hide Job Excerpt from Cycle type?</label><br><input <?php if (isset( $options['greenhouse_job_board_use_excerpt'])) { echo 'checked'; } ?> id="removeCycleEx" type="checkbox" name="greenhouse_job_board_settings[greenhouse_job_board_use_excerpt]" value="Yes">Yes
	</div>
	<?php
...
function greenhouse_job_board_custom_css_render(  ) {
	...
	<?php
     if($options['greenhouse_job_board_custom_css_checkbox'] == 'on'){
		echo '<input type="checkbox" id="custom-css" checked name="greenhouse_job_board_settings[greenhouse_job_board_custom_css_checkbox]"/> <label for="custom-css">Use Custom Css?</label>';
		echo '<div class="custom-css-textarea show">';
	 }else{
		echo '<input type="checkbox" id="custom-css" name="greenhouse_job_board_settings[greenhouse_job_board_custom_css_checkbox]"/> <label for="custom-css">Use Custom Css?</label>';
		echo '<div class="custom-css-textarea hide">';
	}
	?>
	<textarea name="greenhouse_job_board_settings[greenhouse_job_board_custom_css]" class="large-text" rows="20"><?php if(isset($options['greenhouse_job_board_custom_css'])) echo trim($options['greenhouse_job_board_custom_css']);?></textarea>
